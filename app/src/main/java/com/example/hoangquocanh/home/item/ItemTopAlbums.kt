...
import com.example.hoangquocanh.databinding.ItemTopAlbumsBinding

class ItemTopAlbums(private val onClick: (Album) -> Unit) :
    ListAdapter<Album, ItemTopAlbums.ViewHolder>(TopAlbumsDiffCallBack()) {
    inner class ViewHolder(private val binding: ItemTopAlbumsBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = ItemTopAlbumsBinding.inflate(inflater, parent, false)
